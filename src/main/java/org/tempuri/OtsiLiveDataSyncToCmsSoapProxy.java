...
public class OtsiLiveDataSyncToCmsSoapProxy implements org.tempuri.OtsiLiveDataSyncToCmsSoap {
  private String _endpoint = null;
  private org.tempuri.OtsiLiveDataSyncToCmsSoap otsiLiveDataSyncToCmsSoap = null;
  
  public OtsiLiveDataSyncToCmsSoapProxy() {
    _initOtsiLiveDataSyncToCmsSoapProxy();
  }
  
  public OtsiLiveDataSyncToCmsSoapProxy(String endpoint) {
    _endpoint = endpoint;
    _initOtsiLiveDataSyncToCmsSoapProxy();
  }
  
  private void _initOtsiLiveDataSyncToCmsSoapProxy() {
    try {
      otsiLiveDataSyncToCmsSoap = (new org.tempuri.OtsiLiveDataSyncToCmsLocator()).getOtsiLiveDataSyncToCmsSoap();
      if (otsiLiveDataSyncToCmsSoap != null) {
        if (_endpoint != null)
          ((javax.xml.rpc.Stub)otsiLiveDataSyncToCmsSoap)._setProperty("javax.xml.rpc.service.endpoint.address", _endpoint);
        else
          _endpoint = (String)((javax.xml.rpc.Stub)otsiLiveDataSyncToCmsSoap)._getProperty("javax.xml.rpc.service.endpoint.address");
      }
  ...
  public org.tempuri.OtsiLiveDataSyncToCmsSoap getOtsiLiveDataSyncToCmsSoap() {
    if (otsiLiveDataSyncToCmsSoap == null)
      _initOtsiLiveDataSyncToCmsSoapProxy();
    return otsiLiveDataSyncToCmsSoap;
  }
